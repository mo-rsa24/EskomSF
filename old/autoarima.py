...
def automated_forecasts_for_all_types(data: object, selected_columns: object, forecast_dates: object, debug: object = True, n_periods: object = 12,
                                      UFMID: object = 64) -> object:
